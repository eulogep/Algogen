...
| Label « amour » absent | Le test applique une règle de départ fondée sur des termes d’amour. L’interface accepte un champ `isLove` pour remplacer cette heuristique par un étiquetage éditorial. |
